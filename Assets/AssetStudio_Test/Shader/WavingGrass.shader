...
MUL R2.x, R0.y, c[0].y;
MOV R0.x, c[15].w;
DP4 R0.w, R1, c[15].xxyz;
ADD R0.xyz, -R0.x, c[6];
MAD R0.xyz, R0.w, R0, c[15].w;
MIN R0.w, R2.x, c[16].x;
MUL R0.xyz, vertex.color, R0;
...
def c16, 0.47193992, 0.18877596, 0.09438798, -0.50000000
def c17, 0.50000000, 1.00000000, 0.00000000, 0
dcl_position0 v0
dcl_texcoord0 v3
dcl_color0 v5
mul r0.x, v0.z, c7.y
...
mul r2.x, r0.w, c12.y
mov r0.xyz, c6
dp4 r0.w, r1, c16.xxyz
add r0.xyz, c16.w, r0
mad r0.xyz, r0.w, r0, c17.x
min r0.w, r2.x, c17.y
mul r0.xyz, v5, r0
max oD0.w, r0, c17.z
