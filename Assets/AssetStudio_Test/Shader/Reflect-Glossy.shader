...
ADD result.texcoord[3].xyz, -R0, c[15];
...
ADD result.texcoord[3].xyz, -R3.wxyw, c[14];
...
MOV result.texcoord[2].y, R4.z;
MOV result.texcoord[2].x, R5;
ADD result.texcoord[3].xyz, -R3.wxyw, c[15];
...
RSQ R2.x, R2.x;
MAD R2.xyz, R2.x, fragment.texcoord[3], c[0];
DP3 R2.w, R2, R2;
RSQ R2.w, R2.w;
MUL R2.xyz, R2.w, R2;
