...
public class LoadJson<T> : MonoBehaviour
{
    ...
    {
        if (!File.Exists(Application.streamingAssetsPath + "/Data/" + _FileName + ".json"))
        {
            return default(T);
        }

        StreamReader sr = new StreamReader(Application.streamingAssetsPath + "/Data/" + _FileName + ".json");
