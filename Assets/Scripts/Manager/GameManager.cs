...
public class GameManager : Singleton<GameManager>
{
    ...
    {
        //Debug.LogError("levels:" + levelList.levels.Length);

        LevelList levelList1 = levelList;
        levelList1.levels = new LevelData[2];

        LevelData levelData1 = new LevelData();
        levelData1.levelIndex = 0;
        levelData1.Row = 4;
        levelData1.Column = 4;
        levelData1.wallCount = 2;
        levelList1.levels[0] = levelData1;

        LevelData levelData2 = new LevelData();
        levelData2.levelIndex = 1;
        levelData2.Row = 5;
        levelData2.Column = 5;
        levelData2.wallCount = 4;
        levelList1.levels[1] = levelData2;

        Debug.LogError("levels:" + levelList1.levels.Length);
        GameLevelManager.Instance.InitInfo(levelList1);
    }
    private void SuccessLoadScore(AllScoreData allScoreData1)
    {
        //Debug.LogError("scoreDatas:" + allScoreData1.scoreDatas.Count);
        ...
        Debug.LogError("scoreDatas:" + allScoreData.scoreDatas.Count);
    ...
    {
        Debug.Log("***************************");
        SuccessLoadLevel(new LevelList());
        SuccessLoadScore(new AllScoreData());
        //SuccessLoadScore(LoadJson<AllScoreData>.LoadJsonFromFile("ScoreData"));
        //SuccessLoadLevel(LoadJson<LevelList>.LoadJsonFromFile("LevelData"));
